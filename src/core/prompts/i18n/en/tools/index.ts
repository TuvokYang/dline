...
export const toolPromptModules = [
	...
	defineLegacyModule("replaceInFile", "tools", replaceInFile, {
		...
		diffHintLineLabels: createRuntimeContract("LABEL"),
		diffHintSkipDotCount: createRuntimeContract("LINE", "TEXT", "SKIP_MARKER"),
		diffHintFirstLineMissing: createRuntimeContract("TEXT"),
		diffHintBreakPoint: createRuntimeContract("LINE", "TEXT", "FILE_LINE", "FILE_TEXT", "FROM"),
		...
		diffSkipMarkerInReplace: createRuntimeContract("SKIP_MARKER"),
		...
		diffSeparatorConflict: createRuntimeContract("COUNT", "SEARCH_MARKER", "SEPARATOR", "CLOSE_MARKER"),
		diffSeparatorWithText: createRuntimeContract("LINE", "TEXT", "COUNT"),
		diffMarkerCountMismatch: createRuntimeContract("OPEN_COUNT", "SECTION", "LINE", "TEXT", "COUNT"),
