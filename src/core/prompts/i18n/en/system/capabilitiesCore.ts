...
- Runtime capability catalogs may list Skills, Workflows, MCP resources, or Subagents below. Match the task to advertised descriptions, use the exact advertised name, load an item only through its exposed loader, and do not reload instructions already supplied through an \`<explicit_instructions>\` block.
