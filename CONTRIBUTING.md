# Contributing to Dline

We're thrilled you're interested in contributing to Dline. Whether you're fixing a bug, adding a feature, or improving our docs, every contribution makes Dline better. To keep our community vibrant and welcoming, all members must adhere to our [Code of Conduct](CODE_OF_CONDUCT.md).

## Reporting Bugs or Issues

Bug reports help make Dline better for everyone. Before creating a new issue, please [search existing ones](https://github.com/TuvokYang/Dline/issues) to avoid duplicates. When you're ready to report a bug, head over to our [issues page](https://github.com/TuvokYang/Dline/issues/new/choose), where you'll find a template for the relevant information.

<blockquote class='warning-note'>
     <b>Important:</b> If you discover a security vulnerability, please use the <a href="https://github.com/TuvokYang/Dline/security/advisories/new">GitHub security tool to report it privately</a>.
</blockquote>
...
- First check the [Feature Requests discussions board](https://github.com/TuvokYang/Dline/discussions/categories/feature-requests) for similar ideas
...
Looking for a good first contribution? Check out issues labeled ["good first issue"](https://github.com/TuvokYang/Dline/labels/good%20first%20issue) or ["help wanted"](https://github.com/TuvokYang/Dline/labels/help%20wanted). These are curated for new contributors and areas where we'd welcome help.

We also welcome contributions to our [documentation](https://github.com/TuvokYang/Dline/tree/main/docs). Whether it's fixing typos, improving existing guides, or creating new educational content, you can start by exploring `/docs` and looking for areas that need improvement.
...
2. Push your branch and create a PR against the `dev` branch on GitHub. Our CI will:
...
Anyone can contribute code to Dline, but we ask that you follow these guidelines to ensure your contributions can be smoothly integrated:
...
3. **Testing**
    ...
    **End-to-End (E2E) Testing**
    ...
    Dline includes comprehensive E2E tests using Playwright that simulate real user interactions with the extension in VS Code:
    ...
    - **Test environment:**
      - Automated VS Code setup with the Dline extension loaded
...
Contributing to Dline includes code, documentation, tests, and review. Thank you for helping improve the project.
