...
- [Shared Configuration in Dline](#shared-configuration-in-dline)
- [Providers](#providers)
  - [AIHubMix](#aihubmix)
  - [AskSage](#asksage)
  - [Baseten](#baseten)
...
## Shared Configuration in Dline

1. Open Dline settings (⚙️).
...
For the full extension auth flow, see [Authorization & Model Selection](/getting-started/authorizing-with-dline#vs-code-setup).
...
3. In Dline, choose **AIHubMix** and paste the key.
...
3. In Dline, select **AskSage** and enter the key.
...
3. In Dline, choose **Baseten** and paste the key.
...
3. In Dline, select **Cerebras** and enter the key.
...
3. In Dline, select **Dify.ai** and paste your key.
...
3. In Dline, select **Doubao** and paste credentials.
...
3. In Dline, choose **Fireworks AI** and enter the key.
...
3. In Dline, select **GCP Vertex AI** and provide required config values.
...
2. Create an API key.
3. In Dline, select **Groq** and paste the key.
...
3. In Dline, choose **Hicap** and enter the credential.
...
3. In Dline, select **Huawei Cloud MaaS** and add credentials.
...
3. In Dline, select **Hugging Face** and paste the token.
...
3. In Dline, choose **Mistral** and paste the key.
...
3. In Dline, select **Moonshot** and enter the key.
...
3. In Dline, choose **Nebius AI Studio** and provide the credential.
...
3. In Dline, select **NousResearch** and add credentials.
...
3. In Dline, select **Qwen Code** and enter the credential.
...
2. Generate an API key.
3. In Dline, select **Requesty** and paste the key.
...
3. In Dline, choose **SambaNova** and enter credentials.
...
3. In Dline, select **SAP AI Core** and provide required values.
...
2. Generate an API key.
3. In Dline, choose **Together** and paste the key.
...
3. In Dline, select **Vercel AI Gateway** and add the key.

### VS Code Language Model API
VS Code Language Model API support lets Dline use models exposed by the VS Code host environment.
...
3. In Dline, select **VS Code Language Model API**.
...
2. Generate an API key.
3. In Dline, choose **xAI (Grok)** and paste the key.