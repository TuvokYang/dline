---
title: "Z AI (Zhipu AI)"
description: "Learn how to configure and use Z AI's GLM models with Dline. Experience advanced hybrid reasoning, agentic capabilities, and open-source excellence with regional optimization."
---
...
To use the GLM Coding Plans with Dline:
...
3. **Configure in Dline:** Open Dline settings, select "Z AI" as your provider, and paste your API key into the "Z AI API Key" field.

The setup connects your subscription directly to Dline, giving you access to GLM-4.5's tool-calling capabilities optimized for coding workflows.
