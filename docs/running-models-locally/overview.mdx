...
description: "Run Dline with local models using Ollama or LM Studio."
---

Run Dline with local inference on your machine.

## Quick Start

1. Install a local runtime (**Ollama** or **LM Studio**)
2. Start the local server
3. In Dline Settings, select the matching provider
4. Select a local model
5. Enable **Use Compact Prompt** in Dline Settings → Features
...
## Recommended Dline Settings for Local Inference
