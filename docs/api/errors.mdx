...
title: "Errors"
sidebarTitle: "Errors"
description: "Error codes, error formats, mid-stream errors, and retry strategies for the Dline API."
---

The Dline API returns errors in a consistent JSON format. Understanding these errors helps you build reliable integrations.
...
| `402` | Payment Required | Insufficient credits | Add credits at [app.dline.bot](https://app.dline.bot) |
